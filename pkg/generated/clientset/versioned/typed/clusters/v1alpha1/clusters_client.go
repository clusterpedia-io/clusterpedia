...
// ClustersV1alpha1Client is used to interact with features provided by the clusters.clusterpedia.io group.
type ClustersV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ClustersV1alpha1Client) PediaClusters() PediaClusterInterface {
